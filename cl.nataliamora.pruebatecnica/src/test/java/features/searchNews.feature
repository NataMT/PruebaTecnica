...
Scenario: The user should be able to use news
   Given The user is on the google results page for "Tokyo"
   When The user clicks on "news" link at the top of results page
   Then The user should be able to see "Tokyo" related news
